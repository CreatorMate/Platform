    ...
    <form ref="form" @submit.prevent="verify" class="h-full my-4">
        <div class="grid grid-cols-6 gap-2 text-black">
            <input v-for="index in inputs" :key="index"
                   ...
                   class="p-4 h-[56px] verifyBox text-center border text-black bg-white bg-opacity-10 rounded-lg outline-0 focus:border-black focus:border focus:shadow-input"
